package org.onlix.catalog.core.exception;

import lombok.extern.slf4j.Slf4j;
import org.onlix.catalog.core.dto.ApiResponse;
import org.onlix.catalog.core.utils.LogUtils;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleNotValidException(MethodArgumentTypeMismatchException ex) {
    ...
    public ResponseEntity<ApiResponse<Void>> handleNotValidException(MethodArgumentNotValidException ex) {
    ...
    public ResponseEntity<ApiResponse<Void>> handleNotAllowedMethodException(MethodNotAllowedException ex) {
     ...
     * - Http Status: ProductCustomException의 status code
     * - Log Level : Warn
     *
     * @param ex ProductCustomException
     * @return {@link ResponseEntity< ApiResponse >}
     */
    @ExceptionHandler(ProductCustomException.class)
    public ResponseEntity<ApiResponse<Void>> handleAccountCustomException(ProductCustomException ex) {
